...
def menu():
    ...
    print '[5] \x1b[1;95mUpdate Qaiser Commands Tool.'
...
def men():
    ...
    if rana == '':
        ...
        os.system('clear')
        hamza('[!] \x1b[1;92mPlease Wait While Page Is Loding.')
        hopss('10%..Wait.')
        hopss('20%.5..')
        hopss('50%..4.')
        hopss('70%.3..')
        ...
        os.system('clear')
        print banner
        hamza('[\xe2\x9c\x93] \x1b[1;92mPlease Wait While Tool Is Updating')
        os.system('git pull origin master')
        hamza('[\xe2\x9c\x93] \x1b[1;92mTool Has Been Update Successfully')
        hamza('[\xe2\x9c\x93] \x1b[1;92mPlease Wait While Update Is Setting Up On Your Mobile Phone')
        time.sleep(3)
        os.hamza('python2 Khan.py')
    elif rana == '6':
...
def crack_menu():
    ...
    if crm == '':
        ...
        try:
            ...
            hamza('\x1b[1;97m[\xe2\x9c\x93] \x1b[1;95mAccount Name \x1b[1;97m:\x1b[1;97m ' + op['name'])
        except KeyError:
        ...
        print 'Filled Incorrectly'
        crack_menu()
    hamza('[\xe2\x9c\x93] \x1b[1;96mTotal Friends: ' + str(len(id)))
    time.sleep(0.5)
    hamza('[\xe2\x9c\x93] \x1b[1;96mThe Process Has Been Started.')
    time.sleep(0.5)
    hamza('[!] \x1b[1;96mTo Stop Process Press CTRL Then Z')
    time.sleep(0.5)
    print 47 * '-'
    ...
    p.map(main, id)
    print '\x1b[1;97m----------------------------------------------'
    hamza('[\xe2\x9c\x93] \x1b[1;92mProcess Has Been Completed.')
    hamza('\x1b[1;93m[\xe2\x9c\x93] \x1b[1;92mCheckpoint IDS Has Been Saved.')
    xx = str(len(oks))
...
def idfromfriend():
    ...
    try:
        ...
        z = json.loads(r.text)
        hamza('[\xe2\x9c\x93] \x1b[1;92mGetting Friends Numeric IDs...')
        print '--------------------------------------'
...
def emailfromfriend():
    ...
    try:
        ...
        r = requests.get('https://graph.facebook.com/' + idt + '/friends?access_token=' + toket)
        a = json.loads(r.text)
        hamza('[\xe2\x9c\x93] \x1b[1;92mGetting Emails From')
        print 40 * '\x1b[1;97m-'
...
def numberfromfriend():
    ...
    try:
        ...
        r = requests.get('https://graph.facebook.com/' + idt + '/friends?access_token=' + toket)
        a = json.loads(r.text)
        hamza('[\xe2\x9c\x93] \x1b[1;92mGetting All Numbers')
        print 40 * '\x1b[1;97m-'
...
def deletepost():
    ...
    hamza('[\xe2\x9c\x93] \x1b[1;92mThe Process Has Been Started')
    print 40 * '-'
...
def accept():
    ...
    if '[]' in str(teman['data']):
        ...
        raw_input('Press Enter To Back ')
        bot()
    hamza('[\xe2\x9c\x93] The Process Has Been Start')
    print 40 * '-'
    for i in teman['data']:
...
def unfriend():
    ...
    os.system('clear')
    print banner
    hamza('[\xe2\x9c\x93] The Process Has Been Started.')
